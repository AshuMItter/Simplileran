 ...
 handlesubmit(event){
    ...
    render(){
      ...
      <div className='form-group'>
          <input type="text" name="uid" value={this.state.username} onChange={this.handlechange} className='form-control' placeholder="user name"></input>
          

      </div>
      <div className='form-group'>
      
          <input type="text" name="pwd" value={this.state.password} onChange={this.handlechange} className='form-control' placeholder="password"></input>
          

      </div>
      
      <div class="form-check">
  <input class="form-check-input" name="chk" type="checkbox" value={this.state.isLoogedIn} onChange={this.handlechange} id="flexCheckDefault"></input>
